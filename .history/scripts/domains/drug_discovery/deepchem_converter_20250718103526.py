...
class DeepChemToTEAI:
    ...
    def convert_molnet_dataset(
        ...
        # 2. The data is already featurized and cleaned by our robust featurizer
        # Now we can split it directly
        logger.info("Step 2: Splitting the featurized dataset...")
        splitter_fn = dc.splits.ScaffoldSplitter()
        train_data, valid_data, test_data = splitter_fn.train_valid_test_split(raw_dataset)
