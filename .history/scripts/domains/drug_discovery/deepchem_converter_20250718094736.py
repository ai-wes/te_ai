    ...
    def convert_molnet_dataset(
        ...
        if featurizer == 'ECFP':
            try:
                ...
                logger.warning("Could not import MorganGenerator. Using featurizer string name as fallback.")
        ...
        if invalid_smiles_count > 0:
            logger.warning(f"Removed {invalid_smiles_count} invalid SMILES strings from the '{dataset_name_str}' dataset.")
