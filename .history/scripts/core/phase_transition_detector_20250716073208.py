...
class PhaseTransitionDetector:
    ...
    def _compute_early_warning_indicators(self, metrics: Dict, population_state: Dict):
        logger.debug("Entering PhaseTransitionDetector._compute_early_warning_indicators")
    ...
    def _record_transition(self, from_phase: str, to_phase: str, metrics: Dict):
        logger.debug("Entering PhaseTransitionDetector._record_transition")
    ...
    def _increase_diversity_intervention(self, population_manager) -> bool:
        ...
        logger = get_logger()
        logger.log_intervention("increase_diversity", {"population_size": len(population_manager.population)})
    ...
    def update(self, metrics: Dict[str, float], population_state: Dict):
        logger.debug("Entering PhaseTransitionDetector.update")
        ...
        if new_phase != self.current_phase:
            ...
            # Get intervention function if needed
            intervention_name = self.phase_states[new_phase]['intervention']
            if intervention_name:
                intervention_func = self.intervention_strategies[intervention_name]
        
        return intervention_func
