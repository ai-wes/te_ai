...
from scripts.core.anitgen import AntigenEpitope
...
antigen = AntigenEpitope(sequence=cfg.antigen_sequence, structure_coords=cfg.antigen_structure_coords, hydrophobicity=cfg.hydrophobicity, charge=cfg.charge)
