...
class QuantumGeneModule(ContinuousDepthGeneModule):
    ...
    def _normalize_phase_components(self):
        logger.debug("Entering QuantumGeneModule._normalize_phase_components")
    ...
    def post_backward_normalize(self):
        logger.debug("Entering QuantumGeneModule.post_backward_normalize")
    ...
    def compute_probabilities(self):
        logger.debug("Entering QuantumGeneModule.compute_probabilities")
    ...
    def compute_interference(self, prob_0, prob_1):
        logger.debug("Entering QuantumGeneModule.compute_interference")
    ...
    def apply_decoherence(self):
        logger.debug("Entering QuantumGeneModule.apply_decoherence")
    ...
    def entangle_with(self, other_gene: 'QuantumGeneModule'):
        logger.debug("Entering QuantumGeneModule.entangle_with")
    ...
    def normalize_all_quantum_states(population):
        logger.debug("Entering QuantumGeneModule.normalize_all_quantum_states")
