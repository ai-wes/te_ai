...
class AntigenEpitope:
    ...
    def mutate(self, position: int, new_residue: str):
        logger.debug("Entering AntigenEpitope.mutate")
    ...
    def _update_properties(self):
        logger.debug("Entering AntigenEpitope._update_properties")
...
class BiologicalAntigen:
    ...
    def apply_mutations(self, mutation_sites: List[Tuple[int, int]]):
        logger.debug("Entering BiologicalAntigen.apply_mutations")
