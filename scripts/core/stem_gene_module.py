...
class StemGeneModule(ContinuousDepthGeneModule):
    ...
    def sense_population_needs(self, population_stats: Dict, use_rl: bool = False) -> torch.Tensor:
        logger.debug("Entering StemGeneModule.sense_population_needs")
    ...
    def differentiate(self, target_type: Optional[str] = None, 
                     ...
                     use_rl: bool = False):
        logger.debug("Entering StemGeneModule.differentiate")
    ...
    def de_differentiate(self, stress_level: float):
        logger.debug("Entering StemGeneModule.de_differentiate")
    ...
    def update_morphogen(self, neighbor_fields: List[torch.Tensor]):
        logger.debug("Entering StemGeneModule.update_morphogen")
    ...
    def add_new_type(self, new_type: str):
        logger.debug("Entering StemGeneModule.add_new_type")
    ...
    def _update_rl_policy(self, population_stats: Dict):
        logger.debug("Entering StemGeneModule._update_rl_policy")
    ...
    def guided_differentiation(self, patient_state: dict, population_state: dict):
        logger.debug("Entering StemGeneModule.guided_differentiation")
...
class GuidedStemGene(StemGeneModule):
    ...
    def __init__(self):
        logger.debug("Entering GuidedStemGene.__init__")
        super().__init__()
    ...
    def observe_seed_genes(self, population):
        logger.debug("Entering GuidedStemGene.observe_seed_genes")
    ...
    def guided_differentiation(self, stress_level: float = 0.0):
        logger.debug("Entering GuidedStemGene.guided_differentiation")
    ...
    def explore_novel_differentiation(self):
        logger.debug("Entering GuidedStemGene.explore_novel_differentiation")
