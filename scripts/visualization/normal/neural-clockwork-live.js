  ...
  async startPolling() {
    ...
    const poll = async () => {
      ...
      try {
        ...
        const vizType = this.vizType || (window.currentVizType || 'core');
        const jsonPath = vizType === 'therapeutic' 
          ? "../../domains/living_therapeutics_system/therapeutic_visualization_state.json?t=" + Date.now()
          : "../../te_ai_state.json?t=" + Date.now();
